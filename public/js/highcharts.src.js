...
Pointer.prototype = {
	...
	setDOMEvents: function () {
		...
		container.onmousedown = function (e) {
			pointer && pointer.onContainerMouseDown && pointer.onContainerMouseDown(e);
		};
		container.onmousemove = function (e) {
			pointer && pointer.onContainerMouseMove && pointer.onContainerMouseMove(e);
		};
		container.onclick = function (e) {
			pointer && pointer.onContainerClick && pointer.onContainerClick(e);
		};
		...
		if (hasTouch) {
			container.ontouchstart = function (e) {
				pointer && pointer.onContainerTouchStart && pointer.onContainerTouchStart(e);
			};
			container.ontouchmove = function (e) {
				pointer && pointer.onContainerTouchMove && pointer.onContainerTouchMove(e);
			};
			if (chartCount === 1) {
